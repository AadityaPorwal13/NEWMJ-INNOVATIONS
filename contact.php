...
// Record rate limit timestamp BEFORE attempting send
$_ip = $_SERVER['REMOTE_ADDR'] ?? 'unknown';
$_rateFile = __DIR__ . '/rate_limit/' . md5($_ip) . '.txt';
...
try {
    ...
    // Recipients
    $mail->setFrom($_ENV['SMTP_USER'], 'MJ Innovations Website');
        ...
        <table width='600' cellpadding='0' cellspacing='0' style='border-radius:12px; overflow:hidden; border:1px solid #1a2744;'>
          ...
          <tr>
            <td style='background:linear-gradient(135deg,#0B192C 0%,#112240 100%); padding:32px 40px; text-align:center;'>
              ...
              <div style='font-size:22px; color:#ffffff; font-weight:700; letter-spacing:0.5px;'>New Contact Enquiry</div>
          ...
          <tr>
            <td style='background-color:#112240; padding:16px 40px; border-bottom:1px solid #1a2744;'>
              <table width='100%' cellpadding='0' cellspacing='0'>
                <tr>
                  <td style='font-size:12px; color:#64748b; text-transform:uppercase; letter-spacing:1px;'>Enquiry Type</td>
                  <td align='right'><span style='background:#3b82f6; color:#fff; padding:5px 16px; border-radius:20px; font-size:13px; font-weight:600;'>$enquiry</span></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style='background-color:#0f1a2e; padding:30px 40px;'>
              ...
              <table width='100%' cellpadding='0' cellspacing='0' style='font-size:14px;'>
                <tr>
                  <td style='padding:10px 0; border-bottom:1px solid #1a2744; color:#64748b; width:120px;'>Name</td>
                ...
                <tr>
                  <td style='padding:10px 0; border-bottom:1px solid #1a2744; color:#64748b;'>Role</td>
                  <td style='padding:10px 0; border-bottom:1px solid #1a2744; color:#e2e8f0;'>$role</td>
                </tr>
                <tr>
                  <td style='padding:10px 0; color:#64748b;'>Industry</td>
                  <td style='padding:10px 0; color:#e2e8f0;'>$industry</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <!-- Message -->
          <tr>
            <td style='background-color:#0f1a2e; padding:0 40px 30px;'>
              <div style='font-size:11px; color:#3b82f6; letter-spacing:2px; text-transform:uppercase; margin-bottom:14px; font-weight:600;'>Message</div>
          ...
          <tr>
            <td style='background-color:#0f1a2e; padding:0 40px 30px; text-align:center;'>
              <a href='mailto:$email?subject=Re: $enquiry - MJ Innovations' style='display:inline-block; background:#3b82f6; color:#ffffff; padding:12px 36px; border-radius:8px; text-decoration:none; font-size:14px; font-weight:600; letter-spacing:0.5px;'>Reply to $firstName</a>
            </td>
          </tr>
          ...
          <tr>
            <td style='background:#0B192C; padding:20px 40px; border-top:1px solid #1a2744; text-align:center;'>
              <div style='font-size:11px; color:#475569; line-height:1.6;'>
                ...
                <span style='color:#334155;'>This enquiry was submitted securely via your website.</span>
              </div>
            </td>
          </tr>
    ...
    $reply->isHTML(true);
    $reply->Subject = "Thank you for contacting MJ Innovations";
        ...
        <table width='600' cellpadding='0' cellspacing='0' style='border-radius:12px; overflow:hidden; border:1px solid #1a2744;'>
          ...
          <tr>
            <td style='background-color:#033279; padding:30px 40px;'>
              <div style='font-size:15px; color:#ffffff; line-height:1.7; margin-bottom:20px;'>
                We received your message and appreciate you reaching out to us.
              </div>
              <div style='background:#042D6B; padding:20px; border-left:3px solid #42A5F5; border-radius:0 8px 8px 0; color:#B0BEC5; font-size:14px; line-height:1.7;'>
                Our team will review your enquiry and get back to you shortly. We typically respond within <strong style='color:#fff;'>2 business hours</strong>.
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style='background-color:#033279; padding:0 40px 30px;'>
              <div style='font-size:11px; color:#42A5F5; letter-spacing:2px; text-transform:uppercase; margin-bottom:14px; font-weight:600;'>Your Submission</div>
              <table width='100%' cellpadding='0' cellspacing='0' style='font-size:14px;'>
                <tr>
                  <td style='padding:10px 0; border-bottom:1px solid rgba(66,165,245,0.12); color:#90CAF9; width:120px;'>Name</td>
                  <td style='padding:10px 0; border-bottom:1px solid rgba(66,165,245,0.12); color:#ffffff;'>$firstName $lastName</td>
                </tr>
                <tr>
                  <td style='padding:10px 0; border-bottom:1px solid rgba(66,165,245,0.12); color:#90CAF9;'>Enquiry</td>
                  <td style='padding:10px 0; border-bottom:1px solid rgba(66,165,245,0.12); color:#ffffff;'>$enquiry</td>
                </tr>
                <tr>
                  <td style='padding:10px 0; color:#90CAF9;'>Company</td>
    ...
    $reply->AltBody = "Thank you, $firstName!\n\nWe received your message and appreciate you reaching out to us.\n\nOur team will review your enquiry and get back to you shortly. We typically respond within 2 business hours.\n\nYour submission:\nName: $firstName $lastName\nEnquiry: $enquiry\nCompany: $company\n\nMJ Innovations FZ LLC";
    $reply->send();
